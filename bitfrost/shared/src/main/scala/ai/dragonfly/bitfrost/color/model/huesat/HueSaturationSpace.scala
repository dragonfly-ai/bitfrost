...
import ai.dragonfly.bitfrost.color.model.CylindricalColorModel
import ai.dragonfly.bitfrost.color.space.CylindricalColorSpace
import ai.dragonfly.math.squareInPlace
import ai.dragonfly.math.vector.*

trait HueSaturationModel[C <: HueSaturationModel[C]] extends CylindricalColorModel[C] {
  def hue:Double
