...
object CIE2006_2deg_5nm extends SampleSet {
  override val samples:NArray[Sample] = NArray[Sample](
    ...
    Sample(440, Vector3(0.3482554,0.05033657,1.917479)),
    Sample(445, Vector3(0.3418483,0.05743393,1.918437)),
    ...
    Sample(590, Vector3(1.109767,0.8115868,8.494468E-05)),
    Sample(595, Vector3(1.14362,0.7544785,5.460706E-05)),
    Sample(600, Vector3(1.151033,0.6918553,3.549661E-05)),
